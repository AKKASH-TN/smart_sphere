    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text(
            '💡 You could save ₹280 this month by:',
            style: TextStyle(
              color: Colors.white,
              fontSize: 14,
              fontWeight: FontWeight.w600,
          ...
          const Text(
            '• Setting AC to 25°C instead of 22°C\n• Using LED bulbs in bedroom\n• Scheduling water heater optimally',
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildBillItem('Current Month', '₹1,240', Colors.orange),
              _buildBillItem('Projected', '₹1,180', Colors.green),
            ],
          ),
          const SizedBox(height: 16),
          Container(
            ...
            child: const Row(
              children: [
                ...
                SizedBox(width: 8),
                Text(
                  'Estimated savings: ₹60 this month',
                  style: TextStyle(
                    color: Colors.green,
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
